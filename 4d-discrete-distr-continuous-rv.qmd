...
What is the probability that you will draw at least 3 card before drawing the first heart?
...
For $p = 0.2$ (red), most probability is concentrated at small $x$, while for $\pi$ = 0.8 (green), most probability is concentrated at large $x$ near 8–10.
